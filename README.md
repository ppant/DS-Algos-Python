...
- [Singly Linked List](LinkedLists/SingleLinkedListImple.py) & [Doubly Linked List](LinkedLists/DoublyLinkedListImple.py) ($O(1)$)
...
- [Binary Heap](Trees/BinaryHeapImple.py): Min-heap implementation ($O(\log n)$ insert/delete, $O(n)$ build)
...
- [Coin Change Problem](Recursion/): [Recursive](Recursion/CoinChangeProblemRecursion.py) ($O(2^n)$) & [Dynamic Programming](Recursion/CoinChangeProblemDynamic.py) ($O(n \times m)$)
