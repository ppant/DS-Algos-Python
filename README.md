...
- [Singly Linked List](LinkedLists/SingleLinkedListImple.py) ($O(1)$) & [Doubly Linked List](LinkedLists/DoublyLinkedListImple.py) ($O(1)$)
...
- [Binary Search Tree](Trees/BinarySearchTreesImple.py): Complete BST implementation ($O(h)$)
...
- [Tree Representations](Trees/): [Nodes & References](Trees/TreeRepresentationWithNodesReferences.py) ($O(1)$) & [List of Lists](Trees/buildTreeTest.py) ($O(1)$)
...
- [Adjacency List](GraphAlgorithms/AdjacencyListGraphImple.py): Graph ADT implementation ($O(V+E)$)
...
- [Knight's Tour Problem](GraphAlgorithms/): [Graph Generation](GraphAlgorithms/TheKnightsTourProblem.py) ($O(k^N)$) & [DFS Solution](GraphAlgorithms/DFSImpleTheKnightsTourProblem.py) ($O(k^N)$)
